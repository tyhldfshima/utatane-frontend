...
const PERSONAS = [
  {
    ...
    story: '売れていない作曲家も、伴奏をアップするだけ。世界中の作詞家がバースを書き、ミュージシャンが歌い、バージョンが増えるたびに収益が入り続ける。一度作れば、複利で稼ぎ続ける。',
  ...
  },
  {
    ...
    story: '音楽スキルがなくても詞は書ける。詞が「刺さる」と評判になれば、作曲家が次々と曲をつけに来る。SNSで言葉が拡散した瞬間、全バージョンに収益が流れる。',
  ...
  },
  {
    ...
    title: <>歌うたびに、<br/>根が張る。</>,
    story: '演奏を投稿するだけで、購入・TYPの30%を受け取り続ける。YouTubeに上げてバズれば、概要欄のリンクからウタタネへの流入が生まれ、その瞬間に収益が自動分配される。スカウトも来る。',
  ...
  },
  {
    ...
    story: '聴くだけでいい。カラオケモードで気軽に歌っていい。いつでも投稿に踏み出せる。TYPを贈って「ありがとう」を届けることもできる。気づいたら世界中が自分の歌を聴いていた——そんな未来が、ウタタネにはある。',
  ...
  return (
    <div ref={wrapRef} style={{ fontFamily: "'Noto Sans JP', sans-serif" }}>
      ...
      <nav className="lp-nav">
        ...
        <a href="#cta" className="nav-cta">早期登録</a>
      </nav>
      ...
      <section id="revenue" className="lp-revenue">
        <div className="lp-container">
          ...
          <p className="revenue-note lp-reveal">
            ...
            サブスク（¥480〜/月）・1曲購入（¥300〜）・TYP送付（投げ銭）の3つの収益ルートがあります。
          </p>
        </div>
      </section>
