...
export const COPY = {
  ...
  /** ★ログインが要るとき（寄せる設計 §3 設計①）。画面は作らず、この1状態で伝える */
  loginRequired: 'この先は、ログインすると使えます。',
  loginButton: 'ログインする',
  /** ★TYポイントへの行き方（寄せる設計 §3 設計②）。★残高の数字は画面に置かない */
  typLink: 'TYポイントで残高と履歴を見る',
  typLinkNote: 'TYポイントの画面へ移ります',
