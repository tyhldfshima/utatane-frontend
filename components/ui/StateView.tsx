...
// 読み込み中・空・エラー・結果を確認しています・利用不可（Y4 暫定）・準備中。
...
export type StateKind = 'loading' | 'empty' | 'error' | 'checking' | 'unavailable-y4' | 'not-ready'
...
export function StateView({ kind, title, message, retry, showDesignMarks = false }: StateViewProps) {
